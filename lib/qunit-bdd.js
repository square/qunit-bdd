...
void function(global, exports, QUnit, options) {
  ...
  function addTestsToQUnit() {
    ...
    pendingContexts.forEach(function(context) {
      ...
      var beforeHooks = context.gatherHook('before', { insideFirst: false });
      var afterHooks = context.gatherHook('after', { insideFirst: true });
      var lazySetupHooks = context.gatherHook('lazySetup', { insideFirst: false });
      var lazyTeardownHooks = context.gatherHook('lazyTeardown', { insideFirst: true });
