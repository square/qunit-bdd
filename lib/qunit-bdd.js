...
;(function(global, exports, QUnit, options) {
  ...
  /**
   * Allows tests to return promise. Stops QUnit before a run and
   * resumes it after the promise resolves or rejects.
   *
   * If the promise did resolve in time, the test will error out
   * with a timeout message. Default is 1 second.
   *
   * @param {string} description
   * @param {function()} body
   * @param {timeout} timeout
   */
  it.async = function(description, body, timeout) {
